...
/**
 * Factory that produce Interfaces to work against the EJBs layer of business
...
public class EJBProducer
{
   ...
   private JNDIHelper<IUsersManager> usersJndiHelper = new JNDIHelper<IUsersManager>(
         JNDIHelper.USERS_MANAGER_NAME);
