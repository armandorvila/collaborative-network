...
public class JNDIHelper<T>
{
   ...
   private static ResourceBundle resources = ResourceBundle.getBundle("ejb-names");

   public static final String USERS_MANAGER_NAME = resources.getString("ejb.users.name");

   public static final String CONTACTS_MANAGER_NAME = resources.getString("ejb.contacts.name");

   public static final String PROJECTS_MANAGER_NAME = resources.getString("ejb.projects.name");

   public static final String RESOURCES_MANAGER_NAME = resources.getString("ejb.resources.name");
   ...
   public T doLookup()
   {
      ...
      catch (Exception e)
      {
         ...
         throw new EjbLockupException("Error obtain remote ejb for " + jndiName, e);
      }
